        ...
        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-custom description description-wide">
                <label for="edit-menu-item-custom-<?php echo $item_id; ?>">
                    <?php _e( 'Menu Type' ); ?><br />
                    <select id="edit-menu-item-custom-<?php echo $item_id; ?>" class="widefat code edit-menu-item-custom" name="menu-item-custom[<?php echo $item_id; ?>]">
                        <?php
                        $optionsMenu = array('Simple'=>"", 'MegaMenu'=>"hs-has-mega-menu", 'Button'=>"u-header__nav-item-btn");
                        foreach ($optionsMenu as $k=> $opt){
                            $selected = '';
                            if($item->custom == $opt){
                                $selected = "selected";
                            }
                            echo '<option value="'.$opt.'" '.$selected.'>'.$k.'</option>';
                        }
                        ?>
                    </select>
                </label>
